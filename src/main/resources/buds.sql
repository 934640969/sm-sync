...
CREATE TABLE `t_sync_data_incre`  (
  ...
  INDEX `idx_state_updatetime_id`(`STATE`, `UPDATE_TIME`, `ID`) USING BTREE
...
CREATE TABLE `t_sync_data_incre_log`  (
  ...
  `RESULT` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '同步返回详细',
  PRIMARY KEY (`ID`) USING BTREE,
  INDEX `IDX_CREATE_TIME`(`CREATE_TIME`) USING BTREE COMMENT '按创建时间范围查询',
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for t_sync_data_incre_bak
-- ----------------------------
CREATE TABLE `t_sync_data_incre_bak`  (
  `ID` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `TYPE` int(6) NULL DEFAULT NULL COMMENT '1 组织 2 用户',
  `UNIQUE_FIELD` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '组织/用户唯一标识',
  `PARENT_CODE` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '父级唯一标识',
  ...
  PRIMARY KEY (`ID`) USING BTREE,
  INDEX `idx_state_updatetime_id`(`STATE`, `UPDATE_TIME`, `ID`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '同步数据增量备份表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for t_sync_data_incre_log_bak
-- ----------------------------
CREATE TABLE `t_sync_data_incre_log_bak`  (
  `ID` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `TYPE` int(6) NULL DEFAULT NULL COMMENT '1 组织 2 用户',
  `UNIQUE_FIELD` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '组织/用户唯一标识',
  `PARENT_CODE` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '父级唯一标识',
  ...
  PRIMARY KEY (`ID`) USING BTREE,
  INDEX `IDX_CREATE_TIME`(`CREATE_TIME`) USING BTREE COMMENT '按创建时间范围查询',
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '同步数据日志备份表' ROW_FORMAT = Dynamic;
